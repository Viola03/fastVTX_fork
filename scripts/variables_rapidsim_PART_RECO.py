...
############################
# HERE YOU MUST RECOMPUTE B_MOMENTA
############################

# for variable in ['X','Y', 'Z']:
# events['DAUGHTER1_TRUEID']
...
# MOTHER_ORIGINVERTEX_X
# MOTHER_TRUEORIGINVERTEX_X
# MOTHER_ORIGINVERTEX_Y
# MOTHER_TRUEORIGINVERTEX_Y
# MOTHER_ORIGINVERTEX_Z
# MOTHER_TRUEORIGINVERTEX_Z
# MOTHER_TRUEP
# MOTHER_TRUEP_T
# MOTHER_TRUE_FD
# events_edit = events.copy()
# events_edit['MOTHER_PX'] = np.asarray(events_edit['DAUGHTER1_PX']) + np.asarray(events_edit['DAUGHTER2_PX']) + np.asarray(events_edit['DAUGHTER3_PX'])
# events_edit['MOTHER_PY'] = np.asarray(events_edit['DAUGHTER1_PY']) + np.asarray(events_edit['DAUGHTER2_PY']) + np.asarray(events_edit['DAUGHTER3_PY'])
# events_edit['MOTHER_PZ'] = np.asarray(events_edit['DAUGHTER1_PZ']) + np.asarray(events_edit['DAUGHTER2_PZ']) + np.asarray(events_edit['DAUGHTER3_PZ'])
# events_edit['MOTHER_TRUEP_X'] = np.asarray(events_edit['DAUGHTER1_TRUEP_X']) + np.asarray(events_edit['DAUGHTER2_TRUEP_X']) + np.asarray(events_edit['DAUGHTER3_TRUEP_X'])
# events_edit['MOTHER_TRUEP_Y'] = np.asarray(events_edit['DAUGHTER1_TRUEP_Y']) + np.asarray(events_edit['DAUGHTER2_TRUEP_Y']) + np.asarray(events_edit['DAUGHTER3_TRUEP_Y'])
# events_edit['MOTHER_TRUEP_Z'] = np.asarray(events_edit['DAUGHTER1_TRUEP_Z']) + np.asarray(events_edit['DAUGHTER2_TRUEP_Z']) + np.asarray(events_edit['DAUGHTER3_TRUEP_Z'])

events['MOTHER_PX'] = np.asarray(events['DAUGHTER1_PX']) + np.asarray(events['DAUGHTER2_PX']) + np.asarray(events['DAUGHTER3_PX'])
events['MOTHER_PY'] = np.asarray(events['DAUGHTER1_PY']) + np.asarray(events['DAUGHTER2_PY']) + np.asarray(events['DAUGHTER3_PY'])
events['MOTHER_PZ'] = np.asarray(events['DAUGHTER1_PZ']) + np.asarray(events['DAUGHTER2_PZ']) + np.asarray(events['DAUGHTER3_PZ'])
# events['MOTHER_TRUEP_X'] = np.asarray(events['DAUGHTER1_TRUEP_X']) + np.asarray(events['DAUGHTER2_TRUEP_X']) + np.asarray(events['DAUGHTER3_TRUEP_X'])
# events['MOTHER_TRUEP_Y'] = np.asarray(events['DAUGHTER1_TRUEP_Y']) + np.asarray(events['DAUGHTER2_TRUEP_Y']) + np.asarray(events['DAUGHTER3_TRUEP_Y'])
# events['MOTHER_TRUEP_Z'] = np.asarray(events['DAUGHTER1_TRUEP_Z']) + np.asarray(events['DAUGHTER2_TRUEP_Z']) + np.asarray(events['DAUGHTER3_TRUEP_Z'])

events['MOTHER_P'] = np.sqrt(np.asarray(events['MOTHER_PX'])**2 + np.asarray(events['MOTHER_PY'])**2 + np.asarray(events['MOTHER_PZ'])**2)
events['MOTHER_PT'] = np.sqrt(np.asarray(events['MOTHER_PX'])**2 + np.asarray(events['MOTHER_PY'])**2 )




# print('\n')
# with PdfPages('part_reco_mother.pdf') as pdf:
# 	for key in list(events.keys()):
# 		if 'MOTHER' in key:
# 			print(key)
# 			plt.title(key)
# 			plt.hist([events[key], events_edit[key]], bins=50, histtype='step')
